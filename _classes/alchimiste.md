...
### Livre de formules
Vous commencez avec un livre de formules standard gratuit, d'une valeur de 10 pièces d'argents maximum (détaillé à la page <mark>186</mark>). Le livre de formules contient les formules de votre choix de 4 objets alchimiques communs de niveau 1. La liste des objets alchimiques commence à la page <mark>360</mark>.
Chaque fois que vous gagnez un nouveau niveau, vous pouvez ajouter les formules de deux objets alchimiques à votre livre de formules. Ces objets peuvent être de n'importe quel niveau que vous pouvez créer. Vous  apprenez ces formules automatiquement, mais il est également possible de trouver ou d’acheter d’autres formules, ou de les inventer avec le don Inventeur (voir page <mark>167</mark>).
