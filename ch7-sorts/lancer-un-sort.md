...
Généralement, ce type de sorts nécessitent une attaque de contact au corps à corps ou une attaque de contact à distance. Dans les deux cas, effectuez un jet d'attaque et comparez le résultat à la CAC de la cible. Votre modificateur de formation pour les jets d'attaque du sort est le même que votre modificateur de formation pour les jets de sorts. Les attaques de sorts sont des attaques sans arme mais elles ne bénéficient pas des avantages spéciaux provenant de vos armes ou de vos attaques sans arme, et elles n'infligent pas de dégâts en-dehors de ceux indiqués dans la description du sort. Les attaques de contact au corps à corps possèdent le trait finesse (voir <mark>page 182</mark>). En cas d'attaque réussie, votre sort affecte la cible et, en cas d'échec, le sort est perdu (sauf mention contraire). Les sorts avec une portée de "contact" nécessitent toujours une attaque de contact au corps à corps lorsqu'ils sont utilisés contre la volonté de la cible, mais pas lorsque la cible est volontaire ou inconsciente.
